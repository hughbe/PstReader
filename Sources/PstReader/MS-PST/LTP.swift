...
internal struct LTP {
    ...
    private mutating func readPropertyValue(subNodeTree: BTree<Node>?, blocks: [HNDataBlock], property: PCBTH) throws -> Any? {
        ...
        case .multipleBinary:
            ...
            /// When the MV property contains variable-size elements, such as PtypBinary, PtypString, or
            /// PtypString8), the data layout is more complex. The following is the data format of a multi-valued
