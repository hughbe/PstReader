...
final class OutlookPstFileTests: XCTestCase {
    ...
    func testOst() throws {
        do {
            ...
            XCTAssertEqual(UUID(uuidString: "02780600-0000-0000-C000-000000000046"), associatedContents[0].wlinkFolderType!)
            XCTAssertEqual(163174859, associatedContents[0].wlinkSaveStamp!)
            XCTAssertEqual(0, (associatedContents[0].getProperty(id: .unknown0x6612) as UInt32?)!)
            XCTAssertEqual(UUID(uuidString: "B8F00600-0000-0000-C000-000000000046"), associatedContents[0].wlinkGroupHeaderID!)
            ...
            XCTAssertEqual("EX", (messageDetails.getProperty(id: .tagCreatorAddressType) as String?)!)
            XCTAssertEqual(.groupHeaderShortcut, messageDetails.wlinkType!)
            XCTAssertEqual(UUID(uuidString: "B8F00600-0000-0000-C000-000000000046"), messageDetails.wlinkGroupHeaderID!)
            ...
            XCTAssertEqual(163174859, messageDetails.wlinkSaveStamp!)
            ...
            XCTAssertEqual(0x01, messageDetails.conversationIndex!.header.currentFileTime.0)
            XCTAssertEqual(0xD6, messageDetails.conversationIndex!.header.currentFileTime.1)
            XCTAssertEqual(0x8C, messageDetails.conversationIndex!.header.currentFileTime.2)
            XCTAssertEqual(0x49, messageDetails.conversationIndex!.header.currentFileTime.3)
            XCTAssertEqual(0x8C, messageDetails.conversationIndex!.header.currentFileTime.4)
            ...
            XCTAssertEqual("/O=FIRST ORGANIZATION/OU=EXCHANGE ADMINISTRATIVE GROUP(FYDIBOHF23SPDLT)/CN=RECIPIENTS/CN=00037FFE34534C30", (messageDetails.getProperty(id: .tagCreatorEmailAddress) as String?)!)
            ...
            XCTAssertEqual("Hugh Bellamy", (messageDetails.getProperty(id: .tagLastModifierSimpleDisplayName) as String?)!)
            ...
            XCTAssertEqual("Hugh Bellamy", (messageDetails.getProperty(id: .tagCreatorSimpleDisplayName) as String?)!)
            ...
            XCTAssertEqual(UUID(uuidString: "02780600-0000-0000-C000-000000000046"), messageDetails.wlinkFolderType!)
            ...
            XCTAssertEqual(0x00000000, associatedContents[1].wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "CBB89467-E606-4248-A820-9CC1E3B9A128"), associatedContents[1].wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, associatedContents[1].wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), associatedContents[1].wlinkEntryId!.databaseGuid)
            XCTAssertEqual(3660274208866304, associatedContents[1].wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, associatedContents[1].wlinkEntryId!.pad)
            ...
            XCTAssertEqual(UUID(uuidString: "B7F00600-0000-0000-C000-000000000046"), associatedContents[1].wlinkGroupClsid!)
            XCTAssertEqual(0x00000000, (associatedContents[1].wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (associatedContents[1].wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (associatedContents[1].wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            ...
            XCTAssertEqual(254850318, associatedContents[1].wlinkSaveStamp!)
            ...
            XCTAssertEqual(UUID(uuidString: "02780600-0000-0000-C000-000000000046"), associatedContents[1].wlinkFolderType!)
            ...
            XCTAssertEqual(.normal, messageDetails.sensitivity!)
            XCTAssertEqual(0x00000000, messageDetails.wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "CBB89467-E606-4248-A820-9CC1E3B9A128"), messageDetails.wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, messageDetails.wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), messageDetails.wlinkEntryId!.databaseGuid)
            XCTAssertEqual(3660274208866304, messageDetails.wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, messageDetails.wlinkEntryId!.pad)
            XCTAssertEqual(2, (messageDetails.getProperty(id: .unknown0x365A) as UInt32?)!)
            XCTAssertFalse(messageDetails.readReceiptRequested!)
            XCTAssertEqual([0xFE, 0x7F, 0x03, 0x00, 0x53, 0x34, 0x30, 0x4C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], [UInt8]((messageDetails.getProperty(id: .unknown0x0E4C) as Data?)!))
            XCTAssertEqual(.undefined, messageDetails.nativeBody!)
            ...
            XCTAssertEqual(1600275057.0, (messageDetails.getProperty(id: .unknown0x0F02) as Date?)!.timeIntervalSince1970)
            XCTAssertEqual(1600275057.0, messageDetails.messageDeliveryTime!.timeIntervalSince1970)
            XCTAssertEqual(UUID(uuidString: "B7F00600-0000-0000-C000-000000000046"), messageDetails.wlinkGroupClsid!)
            XCTAssertEqual(1033, messageDetails.messageLocaleId!)
            XCTAssertFalse(messageDetails.smartNoAttach!)
            XCTAssertTrue((messageDetails.getProperty(id: .unknown0x36FA) as Bool?)!)
            XCTAssertEqual("EX", (messageDetails.getProperty(id: .tagCreatorAddressType) as String?)!)
            ...
            XCTAssertEqual(1252, messageDetails.messageCodepage!)
            XCTAssertEqual(.normal, messageDetails.importance!)
            XCTAssertEqual(254850318, messageDetails.wlinkSaveStamp!)
            XCTAssertEqual("Hugh Bellamy", (messageDetails.getProperty(id: .tagCreatorSimpleDisplayName) as String?)!)
            ...
            XCTAssertEqual([.read, .unsent, .fai], messageDetails.messageFlags)
            XCTAssertEqual(0, (messageDetails.getProperty(id: .PR_CREATOR_FLAG) as UInt32?)!)
            XCTAssertEqual(0x00000000, (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            XCTAssertEqual("/O=FIRST ORGANIZATION/OU=EXCHANGE ADMINISTRATIVE GROUP(FYDIBOHF23SPDLT)/CN=RECIPIENTS/CN=00037FFE34534C30", (messageDetails.getProperty(id: .tagCreatorEmailAddress) as String?)!)
            XCTAssertEqual(.calendar, messageDetails.wlinkSection!)
            ...
            XCTAssertEqual(UUID(uuidString: "02780600-0000-0000-C000-000000000046"), associatedContents[2].wlinkFolderType!)
            ...
            XCTAssertEqual(1852322938, associatedContents[2].wlinkSaveStamp!)
            XCTAssertEqual(UUID(uuidString: "B7F00600-0000-0000-C000-000000000046"), associatedContents[2].wlinkGroupHeaderID!)
            ...
            XCTAssertEqual(UUID(uuidString: "B7F00600-0000-0000-C000-000000000046"), messageDetails.wlinkGroupHeaderID!)
            XCTAssertEqual(.normal, messageDetails.importance!)
            XCTAssertEqual("Hugh Bellamy", messageDetails.lastModifierName!)
            XCTAssertEqual("Hugh Bellamy", (messageDetails.getProperty(id: .tagCreatorSimpleDisplayName) as String?)!)
            XCTAssertEqual(20127, messageDetails.internetCodepage!)
            XCTAssertEqual(1600275057.0, messageDetails.creationTime!.timeIntervalSince1970)
            XCTAssertEqual(1852322938, messageDetails.wlinkSaveStamp!)
            XCTAssertEqual("pstreadertests@outlook.com", (messageDetails.getProperty(id: .unknown0x5D0B) as String?)!)
            XCTAssertTrue((messageDetails.getProperty(id: .unknown0x36FA) as Bool?)!)
            XCTAssertEqual(1252, messageDetails.messageCodepage!)
            XCTAssertEqual("Hugh Bellamy", (messageDetails.getProperty(id: .tagLastModifierSimpleDisplayName) as String?)!)
            ...
            XCTAssertEqual(0x00000000, associatedContents[3].wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "59DA0729-9DAF-5C4A-B20C-8B81A78C96C0"), associatedContents[3].wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, associatedContents[3].wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "6D7EA9B2-AB73-4D95-BB15-55C15472FCB1"), associatedContents[3].wlinkEntryId!.databaseGuid)
            XCTAssertEqual(0, associatedContents[3].wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, associatedContents[3].wlinkEntryId!.pad)
            ...
            XCTAssertEqual(UUID(uuidString: "69C00638-4C63-6247-AED8-C23CAEA4C626"), associatedContents[3].wlinkClientID!)
            XCTAssertEqual(UUID(uuidString: "02780600-0000-0000-C000-000000000046"), associatedContents[3].wlinkFolderType!)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[3].wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (associatedContents[3].wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (associatedContents[3].wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            XCTAssertEqual(UUID(uuidString: "B7F00600-0000-0000-C000-000000000046"), associatedContents[3].wlinkGroupClsid!)
            XCTAssertEqual(1906209088, associatedContents[3].wlinkSaveStamp!)
            ...
            XCTAssertEqual(1906209088, messageDetails.wlinkSaveStamp!)
            XCTAssertEqual(.normal, messageDetails.importance!)
            XCTAssertEqual("IPM.Microsoft.WunderBar.Link", messageDetails.messageClass!)
            XCTAssertEqual([.read, .unsent, .fai], messageDetails.messageFlags)
            ...
            XCTAssertEqual(0x00000000, (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            ...
            XCTAssertEqual(UUID(uuidString: "69C00638-4C63-6247-AED8-C23CAEA4C626"), messageDetails.wlinkClientID!)
            XCTAssertEqual("My Calendars", messageDetails.wlinkGroupName!)
            XCTAssertEqual(0x00000000, messageDetails.wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "59DA0729-9DAF-5C4A-B20C-8B81A78C96C0"), messageDetails.wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, messageDetails.wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "6D7EA9B2-AB73-4D95-BB15-55C15472FCB1"), messageDetails.wlinkEntryId!.databaseGuid)
            XCTAssertEqual(0, messageDetails.wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, messageDetails.wlinkEntryId!.pad)
            ...
            XCTAssertEqual(UUID(uuidString: "02780600-0000-0000-C000-000000000046"), associatedContents[4].wlinkFolderType!)
            ...
            XCTAssertEqual(208538687, associatedContents[4].wlinkSaveStamp!)
            XCTAssertEqual(12765734618758381569, (associatedContents[4].getProperty(id: .unknown0x67F4) as UInt64?)!)
            XCTAssertEqual(UUID(uuidString: "B9F00600-0000-0000-C000-000000000046"), associatedContents[4].wlinkGroupHeaderID!)
            ...
            XCTAssertEqual(.normal, messageDetails.importance!)
            XCTAssertEqual("IPM.Microsoft.WunderBar.Link", messageDetails.messageClass!)
            XCTAssertEqual(208538687, messageDetails.wlinkSaveStamp!)
            ...
            XCTAssertEqual(UUID(uuidString: "B9F00600-0000-0000-C000-000000000046"), messageDetails.wlinkGroupHeaderID!)
            ...
            XCTAssertEqual(0x00000000, associatedContents[5].wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "CBB89467-E606-4248-A820-9CC1E3B9A128"), associatedContents[5].wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, associatedContents[5].wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), associatedContents[5].wlinkEntryId!.databaseGuid)
            XCTAssertEqual(39279082390683648, associatedContents[5].wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, associatedContents[5].wlinkEntryId!.pad)
            ...
            XCTAssertEqual(UUID(uuidString: "02780600-0000-0000-C000-000000000046"), associatedContents[5].wlinkFolderType!)
            ...
            XCTAssertEqual(208538687, associatedContents[5].wlinkSaveStamp!)
            XCTAssertEqual(UUID(uuidString: "B7F00600-0000-0000-C000-000000000046"), associatedContents[5].wlinkGroupClsid!)
            XCTAssertEqual(0x00000000, (associatedContents[5].wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (associatedContents[5].wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (associatedContents[5].wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            ...
            XCTAssertEqual(.privateFolder, messageDetails.wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), messageDetails.wlinkEntryId!.databaseGuid)
            XCTAssertEqual(39279082390683648, messageDetails.wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, messageDetails.wlinkEntryId!.pad)
            XCTAssertEqual(UUID(uuidString: "B7F00600-0000-0000-C000-000000000046"), messageDetails.wlinkGroupClsid!)
            XCTAssertEqual(-1, messageDetails.wlinkCalendarColor!)
            ...
            XCTAssertEqual(0x00000000, (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[6].wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (associatedContents[6].wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            ...
            XCTAssertEqual(UUID(uuidString: "02780600-0000-0000-C000-000000000046"), associatedContents[6].wlinkFolderType!)
            ...
            XCTAssertEqual(UUID(uuidString: "B7F00600-0000-0000-C000-000000000046"), associatedContents[6].wlinkGroupClsid!)
            ...
            XCTAssertEqual(0x00000000, associatedContents[6].wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "CBB89467-E606-4248-A820-9CC1E3B9A128"), associatedContents[6].wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, associatedContents[6].wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), associatedContents[6].wlinkEntryId!.databaseGuid)
            XCTAssertEqual(39560557367394304, associatedContents[6].wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, associatedContents[6].wlinkEntryId!.pad)
            XCTAssertEqual(208538687, associatedContents[6].wlinkSaveStamp!)
            ...
            XCTAssertEqual(0x01, messageDetails.conversationIndex!.header.currentFileTime.0)
            XCTAssertEqual(0xD6, messageDetails.conversationIndex!.header.currentFileTime.1)
            XCTAssertEqual(0x97, messageDetails.conversationIndex!.header.currentFileTime.2)
            XCTAssertEqual(0xF2, messageDetails.conversationIndex!.header.currentFileTime.3)
            XCTAssertEqual(0xC4, messageDetails.conversationIndex!.header.currentFileTime.4)
            ...
            XCTAssertEqual(.privateFolder, messageDetails.wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), messageDetails.wlinkEntryId!.databaseGuid)
            XCTAssertEqual(39560557367394304, messageDetails.wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, messageDetails.wlinkEntryId!.pad)
            XCTAssertEqual([WlinkFlags(rawValue: 0x00100000)], messageDetails.wlinkFlags)
            XCTAssertEqual("EX", (messageDetails.getProperty(id: .unknown0x4024) as String?)!)
            XCTAssertEqual("My Calendars", messageDetails.wlinkGroupName!)
            ...
            XCTAssertEqual(208538687, associatedContents[7].wlinkSaveStamp!)
            ...
            XCTAssertEqual(UUID(uuidString: "00780600-0000-0000-C000-000000000046"), associatedContents[7].wlinkFolderType!)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[7].wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (associatedContents[7].wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (associatedContents[7].wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            XCTAssertEqual([], associatedContents[7].messageStatus)
            XCTAssertEqual(0x00000000, associatedContents[7].wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "CBB89467-E606-4248-A820-9CC1E3B9A128"), associatedContents[7].wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, associatedContents[7].wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), associatedContents[7].wlinkEntryId!.databaseGuid)
            XCTAssertEqual(4223224162287616, associatedContents[7].wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, associatedContents[7].wlinkEntryId!.pad)
            ...
            XCTAssertEqual(UUID(uuidString: "00780600-0000-0000-C000-000000000046"), messageDetails.wlinkFolderType!)
            ...
            XCTAssertEqual(.privateFolder, messageDetails.wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), messageDetails.wlinkEntryId!.databaseGuid)
            XCTAssertEqual(4223224162287616, messageDetails.wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, messageDetails.wlinkEntryId!.pad)
            XCTAssertEqual("EX", (messageDetails.getProperty(id: .tagCreatorAddressType) as String?)!)
            XCTAssertEqual("pstreadertests@outlook.com", messageDetails.lastModifierName!)
            XCTAssertEqual(1601557199.0, messageDetails.creationTime!.timeIntervalSince1970)
            ...
            XCTAssertEqual(0x00000000, associatedContents[8].wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "CBB89467-E606-4248-A820-9CC1E3B9A128"), associatedContents[8].wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, associatedContents[8].wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), associatedContents[8].wlinkEntryId!.databaseGuid)
            XCTAssertEqual(2534374302023680, associatedContents[8].wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, associatedContents[8].wlinkEntryId!.pad)
            ...
            XCTAssertEqual(UUID(uuidString: "00780600-0000-0000-C000-000000000046"), associatedContents[8].wlinkFolderType!)
            XCTAssertEqual(208538687, associatedContents[8].wlinkSaveStamp!)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[8].wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (associatedContents[8].wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (associatedContents[8].wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            ...
            XCTAssertEqual(.privateFolder, messageDetails.wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), messageDetails.wlinkEntryId!.databaseGuid)
            XCTAssertEqual(2534374302023680, messageDetails.wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, messageDetails.wlinkEntryId!.pad)
            XCTAssertEqual(0x00000000, (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (messageDetails.wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            ...
            XCTAssertEqual(208538687, associatedContents[9].wlinkSaveStamp!)
            ...
            XCTAssertEqual(UUID(uuidString: "00780600-0000-0000-C000-000000000046"), associatedContents[9].wlinkFolderType!)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[9].wlinkStoreEntryId as? GeneralEntryID)!.flags)
            XCTAssertEqual(UUID(uuidString: "38A1BB10-05E5-101A-A1BB-08002B2A56C2"), (associatedContents[9].wlinkStoreEntryId as? GeneralEntryID)!.providerUid)
            XCTAssertEqual([], (associatedContents[9].wlinkStoreEntryId as? GeneralEntryID)!.providerData)
            XCTAssertEqual([], associatedContents[9].messageStatus)
            XCTAssertEqual(0x00000000, associatedContents[9].wlinkEntryId!.flags)
            XCTAssertEqual(UUID(uuidString: "CBB89467-E606-4248-A820-9CC1E3B9A128"), associatedContents[9].wlinkEntryId!.providerUid)
            XCTAssertEqual(.privateFolder, associatedContents[9].wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), associatedContents[9].wlinkEntryId!.databaseGuid)
            XCTAssertEqual(3378799232155648, associatedContents[9].wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, associatedContents[9].wlinkEntryId!.pad)
            ...
            XCTAssertEqual([.read, .unsent, .fai], messageDetails.messageFlags)
            XCTAssertEqual(47351, (messageDetails.getProperty(id: .unknown0x6743) as UInt64?)!)
            XCTAssertEqual(0xC6E0C3F, messageDetails.wlinkSaveStamp!)
            XCTAssertEqual(1601557199.0, messageDetails.messageDeliveryTime!.timeIntervalSince1970)
            XCTAssertEqual("/O=FIRST ORGANIZATION/OU=EXCHANGE ADMINISTRATIVE GROUP(FYDIBOHF23SPDLT)/CN=RECIPIENTS/CN=00037FFE34534C30", (messageDetails.getProperty(id: .unknown0x4025) as String?)!)
            ...
            XCTAssertEqual(.privateFolder, messageDetails.wlinkEntryId!.folderType)
            XCTAssertEqual(UUID(uuidString: "F711B14A-92C8-4094-9843-750BE6086BC4"), messageDetails.wlinkEntryId!.databaseGuid)
            XCTAssertEqual(3378799232155648, messageDetails.wlinkEntryId!.globalCounter)
            XCTAssertEqual(0x0000, messageDetails.wlinkEntryId!.pad)
