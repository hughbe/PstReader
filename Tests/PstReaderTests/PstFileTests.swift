...
final class OutlookPstFileTests: XCTestCase {
    func testExample() throws {
        do {
            ...
            do {
                ...
                XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), recipientRecipientEntryId.providerUid)
                ...
                XCTAssertEqual(GUID(0xA41F2B81, 0xA3BE, 0x1910, 0x9D6E, 0x00DD010F5402), recipientEntryId.providerUid)
                ...
                XCTAssertEqual(GUID(0x666CEE43, 0x46A7, 0x44EF, 0x8EF7, 0xA3FB87FF25E6), pst.messageStore!.ipmWastebasketEntryId!.uid)
                ...
                XCTAssertEqual(GUID(0x666CEE43, 0x46A7, 0x44EF, 0x8EF7, 0xA3FB87FF25E6), pst.messageStore!.ipmSubTreeEntryId!.uid)
                ...
                XCTAssertEqual(GUID(0x666CEE43, 0x46A7, 0x44EF, 0x8EF7, 0xA3FB87FF25E6), pst.messageStore!.finderEntryId!.uid)
        ...
        do {
            let data = try getData(name: "aspose_Outlook")
            let pst = try PstFile(data: data)
            XCTAssertNotNil(pst.rootFolder)
        }
        do {
    ...
    func testAnsi() throws {
        do {
            ...
            XCTAssertEqual(GUID(0xF44601D4, 0x04A0, 0x4BC3, 0xB0DF, 0x2A9DC071B66C), (pst.rootFolder!.ipmAppointmentEntryId as? GeneralEntryID)!.providerUid)
            ...
            XCTAssertEqual(GUID(0xF44601D4, 0x04A0, 0x4BC3, 0xB0DF, 0x2A9DC071B66C), (pst.rootFolder!.ipmContactEntryId as? GeneralEntryID)!.providerUid)
            ...
            XCTAssertEqual(GUID(0xF44601D4, 0x04A0, 0x4BC3, 0xB0DF, 0x2A9DC071B66C), (pst.rootFolder!.ipmJournalEntryId as? GeneralEntryID)!.providerUid)
            ...
            XCTAssertEqual(GUID(0xF44601D4, 0x04A0, 0x4BC3, 0xB0DF, 0x2A9DC071B66C), (pst.rootFolder!.remindersOnlineEntryId as? GeneralEntryID)!.providerUid)
            ...
            XCTAssertEqual(GUID(0xF44601D4, 0x04A0, 0x4BC3, 0xB0DF, 0x2A9DC071B66C), (pst.rootFolder!.ipmNoteEntryId as? GeneralEntryID)!.providerUid)
            ...
            XCTAssertEqual(GUID(0xF44601D4, 0x04A0, 0x4BC3, 0xB0DF, 0x2A9DC071B66C), (pst.rootFolder!.ipmTaskEntryId as? GeneralEntryID)!.providerUid)
    ...
    func testOst() throws {
        do {
            ...
            XCTAssertEqual(0, pst.rootFolder!.children[0].contentUnreadCount!)
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), pst.rootFolder!.children[0].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), pst.rootFolder!.children[0].predecessorChangeList!.values[0].namespaceGuid)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), pst.rootFolder!.children[0].children[0].predecessorChangeList!.values[0].namespaceGuid)
            XCTAssertEqual([0x00, 0x00, 0x00, 0x07], pst.rootFolder!.children[0].children[0].predecessorChangeList!.values[0].localId)
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), pst.rootFolder!.children[0].children[0].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[0].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(GUID(0x0006F0B8, 0x0000, 0x0000, 0xC000, 0x000000000046), associatedContents[0].wlinkGroupHeaderID!)
            XCTAssertEqual(1, associatedContents[0].predecessorChangeList!.values.count)
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[0].predecessorChangeList!.values[0].namespaceGuid)
            ...
            XCTAssertEqual(GUID(0xEAEDEEF7, 0x80F0, 0x7440, 0xA455, 0xE16F5E84EE2A), messageDetails.conversationIndex!.header.guid)
            ...
            XCTAssertEqual(GUID(0xC840A7DC, 0x42C0, 0x1A10, 0xB4B9, 0x08002B2FE182), (messageDetails.lastModifierEntryId as? AddressBookEntryID)!.providerUid)
            ...
            XCTAssertEqual("/O=FIRST ORGANIZATION/OU=EXCHANGE ADMINISTRATIVE GROUP(FYDIBOHF23SPDLT)/CN=RECIPIENTS/CN=00037FFE34534C30", (messageDetails.lastModifierEntryId as? AddressBookEntryID)!.x500DN)
            ...
            XCTAssertEqual(GUID(0x0006F0B8, 0x0000, 0x0000, 0xC000, 0x000000000046), messageDetails.wlinkGroupHeaderID!)
            ...
            XCTAssertEqual(GUID(0x0006F0B7, 0x0000, 0x0000, 0xC000, 0x000000000046), associatedContents[1].wlinkGroupClsid!)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.flags)
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            XCTAssertEqual(0x00, (associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.version)
            XCTAssertEqual(0x00, (associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.flag)
            XCTAssertEqual("EMSMDB.DLL", (associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).flags)
            XCTAssertEqual(GUID(0x20FA551B, 0x66AA, 0xCD11, 0x9BC8, 0x00AA002FC45A), ((associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).providerUid)
            XCTAssertEqual([.homeLogon, .takeOwnership], ((associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).wrappedType)
            XCTAssertEqual("LNXP123MB3820", ((associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).serverShortName)
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30", ((associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).mailboxDN)
            XCTAssertNil(((associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV2)
            XCTAssertNil(((associatedContents[1].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[1].predecessorChangeList!.values[0].namespaceGuid)
            ...
            XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), (associatedContents[1].wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (associatedContents[1].wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), (associatedContents[1].wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[1].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(0x01, messageDetails.conversationIndex!.header.reserved)
            XCTAssertEqual(518316612552.0, messageDetails.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
            XCTAssertEqual(GUID(0x04CB9128, 0xBC1B, 0x8F4E, 0xA7BC, 0x0532F20B90EA), messageDetails.conversationIndex!.header.guid)
            XCTAssertEqual(0, messageDetails.conversationIndex!.responseLevels.count)
            ...
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (messageDetails.wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            ...
            XCTAssertEqual("EMSMDB.DLL", (messageDetails.wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).flags)
            XCTAssertEqual(GUID(0x20FA551B, 0x66AA, 0xCD11, 0x9BC8, 0x00AA002FC45A), ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).providerUid)
            XCTAssertEqual([.homeLogon, .takeOwnership], ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).wrappedType)
            XCTAssertEqual("LNXP123MB3820", ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).serverShortName)
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30", ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).mailboxDN)
            XCTAssertNil(((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV2)
            XCTAssertNil(((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3)
            ...
            XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), (messageDetails.wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (messageDetails.wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), (messageDetails.wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(-1, messageDetails.wlinkCalendarColor!)
                XCTAssertEqual(0, (messageDetails.getProperty(guid: GUID(0x58B6F260, 0x0251, 0x4293, 0x9737, 0x2EF23187F89D), name: "NavigationNodeCalendarArgbColor") as UInt32?)!)
            XCTAssertEqual(21043, (messageDetails.getProperty(id: .unknown0x6743) as UInt64?)!)
            XCTAssertEqual("EX", messageDetails.creatorAddressType!)
            XCTAssertFalse(messageDetails.smartNoAttach!)
            XCTAssertEqual(.undefined, messageDetails.nativeBody!)
            ...
            XCTAssertEqual(1, (messageDetails.getProperty(id: .unknown0x5037) as UInt32?)!)
            XCTAssertEqual(.normal, messageDetails.priority!)
            XCTAssertEqual(GUID(0x0006F0B7, 0x0000, 0x0000, 0xC000, 0x000000000046), messageDetails.wlinkGroupClsid!)
            XCTAssertTrue((messageDetails.getProperty(id: .unknown0x36FA) as Bool?)!)
            XCTAssertEqual(1600275057.0, messageDetails.messageDeliveryTime!.timeIntervalSince1970)
            XCTAssertEqual("/O=FIRST ORGANIZATION/OU=EXCHANGE ADMINISTRATIVE GROUP(FYDIBOHF23SPDLT)/CN=RECIPIENTS/CN=00037FFE34534C30", (messageDetails.getProperty(id: .unknown0x4025) as String?)!)
            ...
            XCTAssertEqual(GUID(0x0006F0B7, 0x0000, 0x0000, 0xC000, 0x000000000046), associatedContents[2].wlinkGroupHeaderID!)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[2].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[2].predecessorChangeList!.values[0].namespaceGuid)
            ...
            XCTAssertEqual([0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x0B, 0x0B, 0xFE, 0x7F, 0x03, 0x00, 0x30, 0x4C, 0x53, 0x34], [UInt8]((messageDetails.getProperty(id: .PR_LAST_MODIFIER_SID) as Data?)!))
            XCTAssertEqual(0, (messageDetails.getProperty(id: .unknown0x1213) as UInt32?)!)
            XCTAssertEqual(GUID(0x0006F0B7, 0x0000, 0x0000, 0xC000, 0x000000000046), messageDetails.wlinkGroupHeaderID!)
            XCTAssertEqual(1, (messageDetails.getProperty(id: .unknown0x5037) as UInt32?)!)
            ...
            XCTAssertEqual(0x01, messageDetails.conversationIndex!.header.reserved)
            XCTAssertEqual(518316612552.0, messageDetails.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
            XCTAssertEqual(GUID(0x43C50A1A, 0x119C, 0xF841, 0x9881, 0xF8367CAC9418), messageDetails.conversationIndex!.header.guid)
            XCTAssertEqual(0, messageDetails.conversationIndex!.responseLevels.count)
            XCTAssertFalse(messageDetails.nonReceiptNotificationRequested!)
            XCTAssertEqual("EX", (messageDetails.getProperty(id: .unknown0x4024) as String?)!)
            XCTAssertEqual([0xFE, 0x7F, 0x03, 0x00, 0x53, 0x34, 0x30, 0x4C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], [UInt8]((messageDetails.getProperty(id: .unknown0x0E4C) as Data?)!))
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[3].predecessorChangeList!.values[0].namespaceGuid)
            ...
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (associatedContents[3].wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            ...
            XCTAssertEqual("pstprx.dll", (associatedContents[3].wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((associatedContents[3].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! PSTPRXEntryIdData).flags)
            XCTAssertEqual(GUID(0x75EB2FE9, 0x5096, 0x8644, 0x83B8, 0x7DE522AA4948), ((associatedContents[3].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! PSTPRXEntryIdData).providerUid)
            XCTAssertEqual("C:\\Users\\hughbe\\AppData\\Local\\Microsoft\\Outlook\\hughbellars@gmail.com.ost", ((associatedContents[3].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! PSTPRXEntryIdData).pathUnicode)
            ...
            XCTAssertEqual(GUID(0x0006F0B7, 0x0000, 0x0000, 0xC000, 0x000000000046), associatedContents[3].wlinkGroupClsid!)
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[3].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(GUID(0x2907DA59, 0xAF9D, 0x4A5C, 0xB20C, 0x8B81A78C96C0), (associatedContents[3].wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (associatedContents[3].wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0x6D7EA9B2, 0xAB73, 0x4D95, 0xBB15, 0x55C15472FCB1), (associatedContents[3].wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(GUID(0x3806C069, 0x634C, 0x4762, 0xAED8, 0xC23CAEA4C626), associatedContents[3].wlinkClientID!)
            ...
            XCTAssertEqual(0x00000000, (messageDetails.wlinkEntryId as? FolderEntryID)!.flags)
            XCTAssertEqual(GUID(0x2907DA59, 0xAF9D, 0x4A5C, 0xB20C, 0x8B81A78C96C0), (messageDetails.wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (messageDetails.wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0x6D7EA9B2, 0xAB73, 0x4D95, 0xBB15, 0x55C15472FCB1), (messageDetails.wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(0x00, (messageDetails.wlinkStoreEntryId as? StoreEntryID)!.version)
            XCTAssertEqual(0x00, (messageDetails.wlinkStoreEntryId as? StoreEntryID)!.flag)
            XCTAssertEqual("pstprx.dll", (messageDetails.wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! PSTPRXEntryIdData).flags)
            XCTAssertEqual(GUID(0x75EB2FE9, 0x5096, 0x8644, 0x83B8, 0x7DE522AA4948), ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! PSTPRXEntryIdData).providerUid)
            XCTAssertEqual("C:\\Users\\hughbe\\AppData\\Local\\Microsoft\\Outlook\\hughbellars@gmail.com.ost", ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! PSTPRXEntryIdData).pathUnicode)
            XCTAssertEqual("IPM.Microsoft.WunderBar.Link", messageDetails.messageClass!)
            XCTAssertEqual(GUID(0x3806C069, 0x634C, 0x4762, 0xAED8, 0xC23CAEA4C626), messageDetails.wlinkClientID!)
            XCTAssertEqual(GUID(0x0006F0B7, 0x0000, 0x0000, 0xC000, 0x000000000046), messageDetails.wlinkGroupClsid!)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[4].predecessorChangeList!.values[0].namespaceGuid)
            XCTAssertEqual([0x00, 0x00, 0x0C, 0x0E], associatedContents[4].predecessorChangeList!.values[0].localId)
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[4].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(GUID(0x0006F0B9, 0x0000, 0x0000, 0xC000, 0x000000000046), associatedContents[4].wlinkGroupHeaderID!)
            ...
            XCTAssertEqual([.read, .unsent, .fai], messageDetails.messageFlags)
            XCTAssertEqual("pstreadertests@outlook.com", messageDetails.lastModifierName!)
            XCTAssertEqual(GUID(0x0006F0B9, 0x0000, 0x0000, 0xC000, 0x000000000046), messageDetails.wlinkGroupHeaderID!)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[5].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), (associatedContents[5].wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (associatedContents[5].wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), (associatedContents[5].wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.flags)
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            XCTAssertEqual(0x00, (associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.version)
            XCTAssertEqual(0x00, (associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.flag)
            XCTAssertEqual("EMSMDB.DLL", (associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).flags)
            XCTAssertEqual(GUID(0x20FA551B, 0x66AA, 0xCD11, 0x9BC8, 0x00AA002FC45A), ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).providerUid)
            XCTAssertEqual([.homeLogon, .takeOwnership], ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).wrappedType)
            XCTAssertEqual("pstreadertests@outlook.com", ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).serverShortName)
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30", ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).mailboxDN)
            XCTAssertNil(((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV2)
            XCTAssertEqual(0xF43246E9, ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.magic)
            XCTAssertEqual(0x00000048, ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.size)
            XCTAssertEqual(0x00000002, ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.version)
            XCTAssertEqual(0x00000010, ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.offsetSmtpAddress)
            XCTAssertEqual("pstreadertests@outlook.com", ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.smtpAddress)
            XCTAssertEqual(0x0000, ((associatedContents[5].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.reserved)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[5].predecessorChangeList!.values[0].namespaceGuid)
            XCTAssertEqual([0x00, 0x00, 0x0C, 0x10], associatedContents[5].predecessorChangeList!.values[0].localId)
            XCTAssertEqual(GUID(0x0006F0B7, 0x0000, 0x0000, 0xC000, 0x000000000046), associatedContents[5].wlinkGroupClsid!)
            ...
            XCTAssertEqual(GUID(0x20FA551B, 0x66AA, 0xCD11, 0x9BC8, 0x00AA002FC45A), ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).providerUid)
            XCTAssertEqual([.homeLogon, .takeOwnership], ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).wrappedType)
            XCTAssertEqual("pstreadertests@outlook.com", ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).serverShortName)
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30", ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).mailboxDN)
            XCTAssertNil(((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV2)
            XCTAssertEqual(0xF43246E9, ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.magic)
            XCTAssertEqual(0x00000048, ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.size)
            XCTAssertEqual(0x00000002, ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.version)
            XCTAssertEqual(0x00000010, ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.offsetSmtpAddress)
            XCTAssertEqual("pstreadertests@outlook.com", ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.smtpAddress)
            XCTAssertEqual(0x0000, ((messageDetails.wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3!.reserved)
            XCTAssertEqual(0x0C6E0C3F, messageDetails.wlinkSaveStamp!)
            XCTAssertEqual(.normalFolder, messageDetails.wlinkType!)
            XCTAssertEqual(.normal, messageDetails.importance!)
            XCTAssertEqual("pstreadertests@outlook.com", messageDetails.lastModifierName!)
            ...
            XCTAssertEqual(GUID(0x0006F0B7, 0x0000, 0x0000, 0xC000, 0x000000000046), associatedContents[6].wlinkGroupClsid!)
            XCTAssertEqual(0x00000000, (associatedContents[6].wlinkEntryId as? FolderEntryID)!.flags)
            XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), (associatedContents[6].wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (associatedContents[6].wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), (associatedContents[6].wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[6].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[6].predecessorChangeList!.values[0].namespaceGuid)
            XCTAssertEqual([0x00, 0x00, 0x09, 0x1C, 0x76, 0x0C], associatedContents[6].predecessorChangeList!.values[0].localId)
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[6].predecessorChangeList!.values[1].namespaceGuid)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.flags)
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            XCTAssertEqual(0x00, (associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.version)
            XCTAssertEqual(0x00, (associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.flag)
            XCTAssertEqual("EMSMDB.DLL", (associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).flags)
            XCTAssertEqual(GUID(0x20FA551B, 0x66AA, 0xCD11, 0x9BC8, 0x00AA002FC45A), ((associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).providerUid)
            XCTAssertEqual([.homeLogon, .takeOwnership], ((associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).wrappedType)
            XCTAssertEqual("LNXP123MB3820", ((associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).serverShortName)
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30", ((associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).mailboxDN)
            XCTAssertNil(((associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV2)
            XCTAssertNil(((associatedContents[6].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3)
            ...
            XCTAssertEqual(GUID(0x059B3B71, 0x1123, 0xDD43, 0xB0A7, 0x85C2D7F862E7), messageDetails.conversationIndex!.header.guid)
            XCTAssertEqual(0, messageDetails.conversationIndex!.responseLevels.count)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.flags)
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            XCTAssertEqual(0x00, (associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.version)
            XCTAssertEqual(0x00, (associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.flag)
            XCTAssertEqual("EMSMDB.DLL", (associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).flags)
            XCTAssertEqual(GUID(0x20FA551B, 0x66AA, 0xCD11, 0x9BC8, 0x00AA002FC45A), ((associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).providerUid)
            XCTAssertEqual([.homeLogon, .takeOwnership], ((associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).wrappedType)
            XCTAssertEqual("LNXP123MB3820", ((associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).serverShortName)
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30", ((associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).mailboxDN)
            XCTAssertNil(((associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV2)
            XCTAssertNil(((associatedContents[7].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3)
            XCTAssertEqual(0x00000000, (associatedContents[7].wlinkEntryId as? FolderEntryID)!.flags)
            XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), (associatedContents[7].wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (associatedContents[7].wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), (associatedContents[7].wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[7].predecessorChangeList!.values[0].namespaceGuid)
            XCTAssertEqual([0x00, 0x00, 0x09, 0x1C, 0x75, 0xF2], associatedContents[7].predecessorChangeList!.values[0].localId)
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[7].predecessorChangeList!.values[1].namespaceGuid)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[7].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(0x01, messageDetails.conversationIndex!.header.reserved)
            XCTAssertEqual(1737666211663.0, messageDetails.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
            XCTAssertEqual(GUID(0xE7597B7C, 0x0998, 0x5E4C, 0x8088, 0x9AA455A7C247), messageDetails.conversationIndex!.header.guid)
            XCTAssertEqual(0, messageDetails.conversationIndex!.responseLevels.count)
            XCTAssertEqual([0xFE, 0x7F, 0x03, 0x00, 0x53, 0x34, 0x30, 0x4C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00], [UInt8]((messageDetails.getProperty(id: .unknown0x0E4B) as Data?)!))
            XCTAssertEqual(1601557199.0, messageDetails.clientSubmitTime!.timeIntervalSince1970)
            XCTAssertEqual(0, (messageDetails.getProperty(id: .PR_CREATOR_FLAG) as UInt32?)!)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[8].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.flags)
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            XCTAssertEqual(0x00, (associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.version)
            XCTAssertEqual(0x00, (associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.flag)
            XCTAssertEqual("EMSMDB.DLL", (associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).flags)
            XCTAssertEqual(GUID(0x20FA551B, 0x66AA, 0xCD11, 0x9BC8, 0x00AA002FC45A), ((associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).providerUid)
            XCTAssertEqual([.homeLogon, .takeOwnership], ((associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).wrappedType)
            XCTAssertEqual("LNXP123MB3820", ((associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).serverShortName)
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30", ((associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).mailboxDN)
            XCTAssertNil(((associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV2)
            XCTAssertNil(((associatedContents[8].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3)
            ...
            XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), (associatedContents[8].wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (associatedContents[8].wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), (associatedContents[8].wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[8].predecessorChangeList!.values[0].namespaceGuid)
            XCTAssertEqual([0x00, 0x00, 0x09, 0x1C, 0x75, 0xF1], associatedContents[8].predecessorChangeList!.values[0].localId)
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[8].predecessorChangeList!.values[1].namespaceGuid)
            ...
            XCTAssertEqual(0x01, messageDetails.conversationIndex!.header.reserved)
            XCTAssertEqual(1737666211663.0, messageDetails.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
            XCTAssertEqual(GUID(0x810B7377, 0xECDC, 0x9841, 0xB6D5, 0x68CEC47DBC0E), messageDetails.conversationIndex!.header.guid)
            XCTAssertEqual(0, messageDetails.conversationIndex!.responseLevels.count)
            XCTAssertFalse(messageDetails.nonReceiptNotificationRequested!)
            XCTAssertEqual(0x00000000, (messageDetails.wlinkStoreEntryId as? StoreEntryID)!.flags)
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (messageDetails.wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            ...
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[9].changeKey!.namespaceGuid)
            ...
            XCTAssertEqual(0x00000000, (associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.flags)
            XCTAssertEqual(GUID(0x10BBA138, 0xE505, 0x1A10, 0xA1BB, 0x08002B2A56C2), (associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.providerUid)
            XCTAssertEqual(0x00, (associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.version)
            XCTAssertEqual(0x00, (associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.flag)
            XCTAssertEqual("EMSMDB.DLL", (associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.dllFileName)
            XCTAssertEqual(0x00000000, ((associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).flags)
            XCTAssertEqual(GUID(0x20FA551B, 0x66AA, 0xCD11, 0x9BC8, 0x00AA002FC45A), ((associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).providerUid)
            XCTAssertEqual([.homeLogon, .takeOwnership], ((associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).wrappedType)
            XCTAssertEqual("LNXP123MB3820", ((associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).serverShortName)
            XCTAssertEqual("/o=First Organization/ou=Exchange Administrative Group(FYDIBOHF23SPDLT)/cn=Recipients/cn=00037FFE34534C30", ((associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).mailboxDN)
            XCTAssertNil(((associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV2)
            XCTAssertNil(((associatedContents[9].wlinkStoreEntryId as? StoreEntryID)!.wrappedProviderData as! EMSMDBEntryIdData).entryIdV3)
            ...
            XCTAssertEqual(GUID(0x6794B8CB, 0x06E6, 0x4842, 0xA820, 0x9CC1E3B9A128), (associatedContents[9].wlinkEntryId as? FolderEntryID)!.providerUid)
            XCTAssertEqual(.privateFolder, (associatedContents[9].wlinkEntryId as? FolderEntryID)!.folderType)
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), (associatedContents[9].wlinkEntryId as? FolderEntryID)!.databaseGuid)
            ...
            XCTAssertEqual(GUID(0xF711B14A, 0x92C8, 0x4094, 0x9843, 0x750BE6086BC4), associatedContents[9].predecessorChangeList!.values[0].namespaceGuid)
            XCTAssertEqual([0x00, 0x00, 0x09, 0x1C, 0x75, 0xF0], associatedContents[9].predecessorChangeList!.values[0].localId)
            XCTAssertEqual(GUID(0xC900D166, 0x479B, 0x4C12, 0xBB9E, 0xC8DC29FA7341), associatedContents[9].predecessorChangeList!.values[1].namespaceGuid)
            ...
            XCTAssertEqual(0x01, messageDetails.conversationIndex!.header.reserved)
            XCTAssertEqual(1737666211663.0, messageDetails.conversationIndex!.header.currentFileTime.timeIntervalSince1970)
            XCTAssertEqual(GUID(0xB37C05E4, 0x9E37, 0x334B, 0xA28B, 0x24248DE1A781), messageDetails.conversationIndex!.header.guid)
            XCTAssertEqual(0, messageDetails.conversationIndex!.responseLevels.count)
